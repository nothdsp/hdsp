...
<dependency>
    ...
    <artifactId>hdsp-dify</artifactId>
</dependency>
```
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.DifyClient;
import io.github.hdsp.dify.client.DifyClientFactory;
import io.github.hdsp.dify.client.DifyChatClient;
import io.github.hdsp.dify.client.DifyCompletionClient;
import io.github.hdsp.dify.client.DifyChatflowClient;
import io.github.hdsp.dify.client.DifyWorkflowClient;
import io.github.hdsp.dify.client.DifyDatasetsClient;
import io.github.hdsp.dify.client.model.DifyConfig;
...
DifyChatflowClient chatflowClient = DifyClientFactory.createChatflowClient("https://api.dify.ai/v1", "your-api-key");
...
import io.github.hdsp.dify.client.model.ChatMessage;
import io.github.hdsp.dify.client.model.ChatMessageResponse;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.callback.ChatStreamCallback;
import io.github.hdsp.dify.client.event.ErrorEvent;
import io.github.hdsp.dify.client.event.MessageEndEvent;
import io.github.hdsp.dify.client.event.MessageEvent;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.Conversation;
import io.github.hdsp.dify.client.model.ConversationListResponse;
import io.github.hdsp.dify.client.model.MessageListResponse;
import io.github.hdsp.dify.client.model.SimpleResponse;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.SuggestedQuestionsResponse;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.AudioToTextResponse;
import java.io.File;
...
import io.github.hdsp.dify.client.DifyCompletionClient;
import io.github.hdsp.dify.client.DifyClientFactory;
import io.github.hdsp.dify.client.model.CompletionRequest;
import io.github.hdsp.dify.client.model.CompletionResponse;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.callback.CompletionStreamCallback;
...
import io.github.hdsp.dify.client.DifyClientFactory;
import io.github.hdsp.dify.client.DifyWorkflowClient;
import io.github.hdsp.dify.client.model.WorkflowRunRequest;
import io.github.hdsp.dify.client.model.WorkflowRunResponse;
import java.util.HashMap;
import java.util.Map;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.callback.WorkflowStreamCallback;
import io.github.hdsp.dify.client.event.NodeFinishedEvent;
import io.github.hdsp.dify.client.event.NodeStartedEvent;
import io.github.hdsp.dify.client.event.WorkflowFinishedEvent;
import io.github.hdsp.dify.client.event.WorkflowStartedEvent;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.WorkflowLogsResponse;
import io.github.hdsp.dify.client.model.WorkflowRunStatusResponse;
import io.github.hdsp.dify.client.model.WorkflowStopResponse;
...
import io.github.hdsp.dify.client.DifyClientFactory;
import io.github.hdsp.dify.client.DifyDatasetsClient;
import io.github.hdsp.dify.client.model.CreateDatasetRequest;
import io.github.hdsp.dify.client.model.DatasetListResponse;
import io.github.hdsp.dify.client.model.DatasetResponse;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.CreateDocumentByTextRequest;
import io.github.hdsp.dify.client.model.DocumentListResponse;
import io.github.hdsp.dify.client.model.DocumentResponse;
import io.github.hdsp.dify.client.model.ProcessRule;
...
```java
// 导入必要的类
import io.github.hdsp.dify.client.model.RetrieveRequest;
import io.github.hdsp.dify.client.model.RetrieveResponse;
import io.github.hdsp.dify.client.model.RetrievalModel;
