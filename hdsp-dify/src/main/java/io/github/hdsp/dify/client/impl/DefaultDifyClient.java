package io.github.hdsp.dify.client.impl;
...
import io.github.hdsp.dify.client.callback.*;
import io.github.hdsp.dify.client.enums.EventType;
import io.github.hdsp.dify.client.enums.ResponseMode;
import io.github.hdsp.dify.client.event.BaseEvent;
import io.github.hdsp.dify.client.event.PingEvent;
import io.github.hdsp.dify.client.exception.DifyApiException;
import io.github.hdsp.dify.client.model.chat.*;
import io.github.hdsp.dify.client.model.common.SimpleResponse;
import io.github.hdsp.dify.client.model.completion.CompletionRequest;
import io.github.hdsp.dify.client.model.completion.CompletionResponse;
import io.github.hdsp.dify.client.model.workflow.*;
import io.github.hdsp.dify.client.util.JsonUtils;
...
public class DefaultDifyClient extends DifyBaseClientImpl implements DifyClient {
    ...
    @Override
    public io.github.hdsp.dify.client.model.chat.AppFeedbacksResponse getAppFeedbacks() throws IOException, DifyApiException {
        log.debug("获取应用反馈列表");
        return executeGet(APP_FEEDBACKS_PATH, io.github.hdsp.dify.client.model.chat.AppFeedbacksResponse.class);
    }
